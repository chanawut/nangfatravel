...
$(document).ready(function(){      
	...
	function init_template(){        
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        var nameValidatorTH = /[ก-๙A-Za-z]{2}[ก-๙A-Za-z]*[ ]?[ก-๙A-Za-z]*/;
        var phoneValidatorTH = /^0[1-9][0-9]{7,8}$/; // /^([0]{1})*([0-9]{8,9})$/;
        ...
        $('.input-required input[type="nameTH"]').on('focusout',function(){if (nameValidatorTH.test($(this).val())){$(this).parent().find('em').html(validIcon);}else{if($(this).val() === ""){$(this).parent().find('em').html("(required)");}else{$(this).parent().find('em').html(invalidIcon);}}});      
        $('.input-required input[type="telTH"]').on('focusout',function(){if (phoneValidatorTH.test($(this).val())){$(this).parent().find('em').html(validIcon);}else{if($(this).val() === ""){$(this).parent().find('em').html("(required)");}else{$(this).parent().find('em').html(invalidIcon);}}});
